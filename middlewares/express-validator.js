...
let validacoesCadastro = [
    check("nome").notEmpty().withMessage("Preencha o seu nome completo").isLength({ min: 3 }).withMessage("O nome deve ter pelo menos 3 caracteres"),
    ...
    check("confirmarsenha").isLength({ min: 6, max: 10 }).withMessage(" ").custom((confirmarsenha, { req }) => {
